...
from . import views
from .views import VoitureListView, VoitureDetailView, reserver_voiture ,reservation_confirmed , user_reservations
...
urlpatterns=[
  ...
  path('mes_reservations/', user_reservations, name='user_reservations'),    path('reservation_confirmed/', reservation_confirmed, name='reservation_confirmed'),
